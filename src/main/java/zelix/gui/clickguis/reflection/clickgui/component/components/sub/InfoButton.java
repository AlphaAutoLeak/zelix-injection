...
public class InfoButton extends Component
{
    ...
    public InfoButton(final Button button, final Hack mod, final int offset) {
        this.parent = button;
        this.mod = mod;
    ...
    public void renderComponent() {
        ...
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow("Info", (float)((this.parent.parent.getX() + 7) * 2), (float)((this.parent.parent.getY() + this.offset + 2) * 2 + 5), -1);
        GL11.glPopMatrix();
    }
    ...
    public void mouseClicked(final int mouseX, final int mouseY, final int button) {
        if (this.isMouseOnButton(mouseX, mouseY) && button == 0 && this.parent.open) {
            ChatUtils.message(EnumChatFormatting.ITALIC + this.mod.getDescription() + ".");
        }
    }
